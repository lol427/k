...
\end{parti}
\sol Fie $K=\max_{[0,1]}|f|$. Funcția $f$ este doar continuă, deci nu putem deriva $f(x^{\alpha})$ în raport cu $\alpha$; mutăm parametrul de pe $f$ pe o putere, prin substituția $y=x^{\alpha}$ (ca în ONM.16), iar singularitatea din $0$ o tratăm explicit, cu limite de integrale pe $[\varepsilon,1]$.
